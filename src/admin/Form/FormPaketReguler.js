        ...
        axios.post("http://localhost:5000/pkt_reguler/tambah", formData)
            .then(response => {
                ...
                setTimeout(() => {
                    ...
                    navigate("/paket_reguler_tersedia");
                }, 2000);
            })
            .catch(error => {
        ...
        <div className="bg-yellow-50 min-h-screen">
            ...
            <div className="max-w-md mx-auto mt-5">
                <div className="bg-slate-300 p-8 rounded-lg shadow-lg relative">
                    <h2 className="text-xl font-semibold mb-4 text-center">Form Paket Reguler</h2>
...
export default FormPaketReguler;
