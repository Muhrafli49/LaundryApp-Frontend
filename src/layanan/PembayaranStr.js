    ...
    const handleSubmit = async (e) => {
        ...
        if (parsedTotalAmount >= totalHarga) {
            try {
                ...
                await axios.put(`/order_str/edit/${id}`, {
                    status: true
                });
        ...
        <div className="bg-gradient-to-b from-orange-100 to-orange-500 h-screen relative flex items-center justify-center">
            ...
            <div className="max-w-xl bg-white shadow-md rounded-lg overflow-hidden relative">
                ...
                <div className="p-5 text-center">
                    ...
                    <h5 className="text-md font-bold mb-4">#Total Nominal: {order.totalBayarStr ? order.totalBayarStr.toLocaleString('id-ID', { style: 'currency', currency: 'IDR', minimumFractionDigits: 0, maximumFractionDigits: 0 }) : '-'}</h5>
